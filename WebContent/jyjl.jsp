			...
			<div class="col-md">
				<div class="card">
				  ...
				  <ul class="list-group list-group-flush">
					  <li class="list-group-item">平安银行  <h5 class="text-secondary" style="margin-left: 600px;">+1000</h5></li>
					  <li class="list-group-item  bg-light">汇添富中证生物课科     <h5 class="text-dark" style="margin-left: 600px;">+2000</h5></li>
					  <li class="list-group-item">易方达中证万得生  <h5 class="text-secondary" style="margin-left: 600px;">+1200</h5></li>
					</ul>
				  </div>
				</div>
