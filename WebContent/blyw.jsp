		...
		<div class="row">
			...
			<div id="nav">
				<ul>
					...
					<li class="bar">|</li>
					<li><a href="blyw.jsp" target="_self "class="text-primary">业务办理</a></li>
					<li class="bar">|</li>

				</ul>
			 </div>
			 
				<div class="card" style="width:800px;height:400px; position: absolute;margin-top: 20px;left:20px;">
				  <div class="card-body">
				    <h5 class="card-title ">业务办理</h5>
				      <div class="container">
					  <div class="row ">
					    <div class="col">
					    	  <img style="width:100px"src="image/账户.png">
					          <span class="badge badge-light w-75 p-3">个人信息</span>
					    </div>
					    <div class="col">
					    	  <img style="width:100px"src="image/我的订阅.png">
					          <span class="badge badge-light w-75 p-3">我的订阅</span>
					    </div>
					    <div class="col">
					    	   <img style="width:100px"src="image/风险评估.png">
					           <span class="badge badge-light w-75 p-3">风险评估</span>
					    </div>
					    <div class="col">
					         <img style="width:100px"src="image/信息更新.png">
					         <span class="badge badge-light w-75 p-3">信息更新</span>
					    </div>
					  
					    <div class="w-100 p-3"></div>
					    <div class="col">
					    	 <img style="width:100px"src="image/存管变更.png">
					         <span class="badge badge-light w-75 p-3">存管变更</span>
					    </div>
					    <div class="col">
					    	  <img style="width:100px"src="image/修改密码.png">	
					          <span class="badge badge-light w-75 p-3">修改密码</span>
					    </div>
					    <div class="col">
					   		 <img style="width:100px"src="image/修改绑定手机号.png">
					         <span class="badge badge-light w-75 p-3">修改绑定手机号</span>
					    </div>
					    <div class="col">
					    	<img style="width:100px"src="image/设置.png">
					        <span class="badge badge-light w-75 p-3">设置</span>
					    </div>
					  </div>
					</div>
				  </div>
